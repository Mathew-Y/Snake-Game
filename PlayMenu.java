...
{ // Start of PlayMenu class, extends JPanel class, implements Runable class
    ...
    private File easy_file = null; // File that will store the file location of the easy image
    private Image easy_image = null; // Image that will store the easy image for the play menu
    private File medium_file = null; // File that will store the file location of the medium image
    private Image medium_image = null; // Image that will store the medium image for the play menu
    private File hard_file = null; // File that will store the file location of the hard image
    private Image hard_image = null; // Image that will store the hard iamge for the play menu
    ...
    { // Start of PlayMenu constructor
        ...
        { // Start of try statement
            easy_file = new File("C:\\Users\\mathe\\Desktop\\easySnakeGamePicture.png"); // File variable that will store the location of the easy image on my computer
            easy_image = ImageIO.read(easy_file); // Try and read the easy_file variable and convert it to the easy_image variable
        ...
        try
        { // Start of try statement
            medium_file = new File("C:\\Users\\mathe\\Desktop\\mediumModeSnakePicture.png"); // File variable that will store the location of the medium image on my computer
            medium_image = ImageIO.read(medium_file); // Try and read the medium_file variable and convert it to the medium_image variable
        } // End of try statement
        catch(IOException e) // Catch the IOException error
        { // Start of catch statement
            e.printStackTrace(); // Handles IOException error
        ...
        try
        { // Start of try statement
            hard_file = new File("C:\\Users\\mathe\\Desktop\\hardModeSnakePicture.png"); // File variable that will store the location of the hard image on my computer
            hard_image = ImageIO.read(hard_file); // Try and read the hard_file variable and convert it to the hard_image variable
        } // End of try statement
    ...
    { // Start of paintComponent method
        ...
        g.drawImage(easy_image, 33, 270, this); // Drawing the easy_image on the play menu
        g.drawImage(medium_image, 350, 270, this); // Drawing the medium_image on the play menu
        g.drawImage(hard_image, 667, 270, this); // Drawing the hard_image on the play menu
